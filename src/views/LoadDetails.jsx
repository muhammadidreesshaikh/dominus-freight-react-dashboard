                        ...
                        <div className="list-group">
                          ...
                          <a href="#" className="list-group-item list-group-item-action">
                            <div className="d-flex w-100 justify-content-between">
                              ...
                              <small className="text-muted">DHL Co</small>
                            </div>
                          </a>
                          ...
                          <a href="#" className="list-group-item list-group-item-action">
                            <div className="d-flex w-100 justify-content-between">
                              ...
                              <small className="text-muted">Allex</small>
                            </div>
                          </a>
                          ...
                          <a href="#" className="list-group-item list-group-item-action">
                            <div className="d-flex w-100 justify-content-between">
                              ...
                              <small className="text-muted">Tempa</small>
                            </div>
                          </a>
                          ...
                          <a href="#" className="list-group-item list-group-item-action">
                            <div className="d-flex w-100 justify-content-between">
                              ...
                              <small className="text-muted">+92 333 7148980</small>
                            </div>
                          </a>
                          ...
                          <a href="#" className="list-group-item list-group-item-action">
                            <div className="d-flex w-100 justify-content-between">
                              ...
                              <small className="text-muted">Florida</small>
                            </div>
                          </a>
                          ...
                          <a href="#" className="list-group-item list-group-item-action">
                            <div className="d-flex w-100 justify-content-between">
                              ...
                              <small className="text-muted">05:00 PM</small>
                            </div>
                          </a>
                          ...
                          <a href="#" className="list-group-item list-group-item-action">
                            <div className="d-flex w-100 justify-content-between">
                              ...
                              <small className="text-muted">loremipsm loremipsm</small>
                            </div>
                          </a>
                        </div>
                      </Col>
